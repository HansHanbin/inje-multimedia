    ...
    <>
      ...
      <div className="project">
        <div className="project-container">
          ...
          <Link to="/2022/project/mm" className="project-vi major">
            {/* 마우스오버 전 */}
            <div className="project-before before">
              <h4>V.I</h4>
              <h6>비주얼인포메이션디자인</h6>
                      ...
                      <div className="project-wrapper__major">
                        ...
                        <div className="project-wrapper-research">
                          ...
                          <div className="project-wrapper__majorDescription">
                            ...
                            공공디자인 등의{" "}
                            <strong>
                              주제를 다양한 방법으로 접근하여 문제를 해결
                            </strong>
                            하는 과정이다. 학생들은 사회적 문화적으로 나타나는
                            <strong>
                              아젠다(agenda)나 이슈(issue) 등을 시각 정보디자인
                              방법으로 문제 해결
                            </strong>
                            한다.
                          </div>
          ...
          <Link to="/2022/project/vi" className="project-mm major">
            {/* 마우스오버 전 */}
            <div className="project-before before">
              <h4>M.M</h4>
                      ...
                      <div className="project-wrapper__major">
                        <div className="project-wrapper-studio">
                          ...
                          <div className="project-wrapper__majorDescription">
                            ...
                            바탕으로{" "}
                            <strong>창의적 표현의 도구로서 매체를 활용</strong>
                            하고{" "}
                            <strong>
